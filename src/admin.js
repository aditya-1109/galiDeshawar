            ...
            {data?.map((lotteryModel, index) => (
              <div className="lotteryContainer">
                ...
                <form className="lottery-form" onSubmit={(e) => handleSubmit(e, lotteryModel.lotteryName)}>
                  <input  onChange={(e) => handleChange(e, lotteryModel.lotteryName, "open",)} type="text" placeholder="open" />
                  <input  onChange={(e) => handleChange(e, lotteryModel.lotteryName, "close",)} type="text" placeholder="close" />
